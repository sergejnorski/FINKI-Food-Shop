...
export const GET_RESTAURANT_EVENTS_REQUEST_BY_ID = "GET_RESTAURANT_EVENTS_REQUEST_BY_ID";
export const GET_RESTAURANT_EVENTS_SUCCESS_BY_ID = "GET_RESTAURANT_EVENTS_SUCCESS_BY_ID";
export const GET_RESTAURANT_EVENTS_FAILURE_BY_ID = "GET_RESTAURANT_EVENTS_FAILURE_BY_ID";
